...
- **Create_note_vulnerablee** – this also demonstrates the use of seeds without consideration for uniqueness leading to PDA collision.

- **Update_note_secure** – This shows anchor constraints ensuring only the owner of the notepad modifies account.
- **Update_note_vulnerablee** – lacks any anchor constraints ensuring or authorization check leading to mofifying other's account.
